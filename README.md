...
- 建立统一的平台目录和接入矩阵，按 CSGOSKINS.GG markets 目录纳入 32 个市场，并按需求手动纳入 market.csgo.com。
...
| 平台覆盖 | 覆盖 33 个市场，包括 32 个 CSGOSKINS.GG markets 目录市场和手动新增的 market.csgo.com |
| 样例行情覆盖 | 为 33 个平台生成确定性样例盘口，参与报价矩阵和利差排序 |
...
平台列表以 CSGOSKINS.GG markets 目录为基础，并手动新增 market.csgo.com。当前已纳入 33 个市场：

Steam、CSFloat、LIS-SKINS、CS.MONEY、Skinport、Tradeit.gg、BUFF163、GameBoost、DMarket、CS2、PirateSwap、SkinSwap、Skin.Land、Avan.market、Skinflow、Aim.market、Mannco.store、white.market、SkinBaron、SkinPlace、BUFF Market、ShadowPay、WAXPEER、SkinOut、CS.TRADE、Skinvault、UUSKINS、Skins.com、CSGO Market、HaloSkins、Exeskins、NTSkins、Dupe。

说明：纳入目录和样例行情覆盖不等于已完成真实交易接入。当前系统用目录级样例盘口完成 33 平台报价矩阵和利差排序，同时明确标记真实行情、费率、库存、余额、执行和对账能力的正式接入状态。
...
| `docs/平台接入矩阵.md` | 33 个市场的目录字段、能力字段和接入状态 |
